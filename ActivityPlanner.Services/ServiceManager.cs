...
namespace ActivityPlanner.Services
{
    public class ServiceManager : IServiceManager
    {
        ...
        public ServiceManager(IRepositoryManager repositoryManager, IMapper mapper, UserManager<AppUser> userManager, IConfiguration configuration, IRedisCacheService redisCacheService)
        {
        ...
        public IRedisCacheService RedisCacheService => _redisCacheService;
    }
}
